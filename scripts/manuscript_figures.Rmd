...
# output to .csv
write.csv("output/cleaned_data/mast_output_dataframe.csv")
...
# Run normality on the temp data
qqPlot(temperature_data$Temp, main = "QQ Plot of Temperature Data")

# Data is not normal so log transform
qqPlot(temperature_data$log(Temp), main = "QQ Plot of Temperature Data")

# Fit linear model
lm_model <- lm(log(Temp) ~ Date + Site, data = temperature_data)
