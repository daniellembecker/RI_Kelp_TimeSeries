...
# load species names and species code dataframe
species.metadata <- read.csv("data/species_code_metadata.csv")

# Convert species names to codes
updated.swath <- for (col in names(swath)) {
  swath[, col] <- species.metadata$code[match(swath[, col], species.metadata$species.substrate)]
}

#some of the species in swath dataframe are common names and species metadata in species names
