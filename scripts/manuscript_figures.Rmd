...
#notice some dates and data missing, Austin has to look this over!
...
# Calculate the kelp blade length
merge.morph.quad$kelp_blade_length <- merge.morph.quad$BLADE_WIDTH_CM * merge.morph.quad$BLADE_LENGTH_CM

# Calculate the sum of blade length and stipe length
merge.morph.quad$sum_length <- merge.morph.quad$kelp_blade_length + merge.morph.quad$STIPE_LENGTH_CM
