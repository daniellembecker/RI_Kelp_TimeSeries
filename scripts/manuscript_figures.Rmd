...
com = invert.count[,6:ncol(invert.count)]

# Calculate Bray-Curtis dissimilarity
m_com <- vegdist(com, method = "bray")

# Check for warnings and errors
if (any(warnings())) {
  warning("Warnings during distance calculation:", warnings())
}

# Remove empty rows (if applicable)
m_com <- as.matrix(m_com[complete.cases(m_com), ])

# Check dimensions of m_com after removing empty rows
dim(m_com)
