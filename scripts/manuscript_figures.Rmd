...
quad.filt <- QUAD %>%
  filter(SP_CODE == "SUGK" | SP_CODE == "LADI")
...
morph.filt <- morph %>%
        filter(SP_CODE == "SL" | SP_CODE == "LADI")
...
# Calculate fish biomass
PB_filtered$biomass <- PB_filtered$Wmat * PB_filtered$COUNT

# Calculate biomass per m²
PB_filtered$biomass_per_m2 <- PB_filtered$biomass / 80
