...
hpi_summary <- PB %>%
  ...
  summarise(mean_HPI = mean(HPI))


ggplot(hpi_summary, aes(x = paste(TRANSECT, SITE, sep = " - "), y = mean_HPI, fill = as.factor(YEAR))) +
  geom_bar(stat = "identity", position = "dodge", color = "black") +
  labs(x = "Transect - Site", y = "Mean Habitat Productivity Index (HPI)") +
  theme_minimal() +
