...
# Calculate habitat productivity index for all transects 
...
```{r}
# Combine the plots with patchwork for all years of kelp and rate of change
production.hpi.nonlog <- production_plot | hpi.plot.nonlog +
  plot_annotation(tag_levels = 'A') + 
...
# Combine the plots with patchwork for all years of kelp and rate of change
production.hpi.log <- production_plot | hpi_plot_log +
  plot_annotation(tag_levels = 'A') + 
