...
# COVER data frame is its own category, is this supposed to combine with another? it was labeled, Kelp_COVER 
...
# the one QUAD data.frame has 130 variables because each species is listed instead of its code, fo you want me to replace with the code and make it wide to long format?
